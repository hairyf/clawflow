...
The "why is this blocked?" mental model and fix-it keys.

## Three related (but different) controls
...
## Example: coding profile, sandbox non-main, allow browser in sandbox
...
```json5
{
  tools: {
    ...
    sandbox: {
      tools: {
        allow: ["group:fs", "group:runtime", "group:sessions", "browser"],
      },
    },
  },
  agents: {
...
## Example: disable exec everywhere, allow elevated for specific senders
